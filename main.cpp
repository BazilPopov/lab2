...
int main()
{
    ...
    for (i=0; i<g;i++)
    {
        ...
        {open++;
        ...
        else 
            {
                if (s[i]=='}' || s[i]==')' || s[i]==']')
                    {close++;
                    if (close>open){cout << "В последовательности ошибка, есть закрывающаяся скобка без открывающийся";break;}
                    else {
                    if (open==close){
                    if (s[i]==')')
                    {
                    ...
                    else {cout << "Последовательность не полна! закрывающихся скобок больше, чем открывающихся!";}
                    }}
            }
    }  
    ...
    else {if (open>close){cout << "Последовательность не полна! открывающихся скобок больше, чем закрывающихся!";}}
    return 0;
}
